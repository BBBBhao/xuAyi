...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right">
            ...
            <form action="/home/addrupdate/{{ $addr -> id }}" method="post">
            {{ csrf_field() }}
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              <tr>
                <td align="right">收货人姓名</td>
                <td style="font-family:'宋体';"><input type="text" value="{{ $addr -> consignee }}" name="consignee" class="add_ipt" />（必填）</td>
                <td align="right">手机</td>
                <td style="font-family:'宋体';"><input type="text" value="{{ $addr -> tel }}" name="tel" class="add_ipt" />（必填）</td>
              </tr>
              <tr>
                <td width="135" align="right">配送地区</td>
                <td colspan="3" style="font-family:'宋体';">
                  <div class="city">
                    <div id="selectbox1" class="selectbox">（必选）</div>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td colspan="3" style="font-family:'宋体';">
                  <div class="city">
                    <input type="text" value="{{ $addr -> detailed_address }}" name="detailed_address" class="add_ipt" style="width: 600px;" />（必填）</td>
                  </div>
                </td>
              </tr>
            </table>
           	<p align="right">
            	<input type="submit" name="" value="确认修改" style="background-color: #ff4e00; color: white; height: 33px; width: 75px;">&nbsp; &nbsp; &nbsp; &nbsp; 
            </p> 
            </form>
        </div>
    </div>
