...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right">
            ...
            <form action="/home/doaddr" method="post">
            {{ csrf_field() }}
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              <tr>
                <td align="right">收货人姓名</td>
                <td style="font-family:'宋体';"><input type="text" value="" name="consignee" placeholder="收货人姓名" class="add_ipt" />（必填）</td>
                <td align="right">联系电话</td>
                <td style="font-family:'宋体';"><input type="text" value="" name="tel" placeholder="联系电话" class="add_ipt" />（必填）</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="3" style="font-family:'宋体';">
                  <div class="city">
                    <input type="text" value="" name="detailed_address" placeholder="详细地址" class="add_ipt" style="width: 600px;" />（必填）</td>
                  </div>
                </td>
              </tr>
            </table>
            <p align="right">
             &nbsp; &nbsp; <input type="submit" name="" value="确认" style="background-color: #ff4e00; color: white; height: 33px; width: 75px;">&nbsp; &nbsp; &nbsp; &nbsp; 
            </p> 
            </form>
        </div>
    </div>
