...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <!--[if IE 6]>
    <script src="/Home_/js/iepng.js" type="text/javascript"></script>
...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
            @if(session('user'))
            <span class="fl"><a href="/home/center">{{ session('user')['uname'] }}</a> | @if(session('user')['identity'] == 1)<a href="/admin/login" style="color:#ff4e00;">后台管理</a> | @endif<a href="/home/loginout" style="color:#ff4e00;">退出登录</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
            @else
...
<div class="top">
    <div class="logo"><a href="Index.html"><img src="/Home_/images/logo.png" /></a></div>
    <div class="search">
    	<form>
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
            ...
            <ul class="cars">
            	<li>
                	<div class="img"><a href="#"><img src="/Home_/images/car1.jpg" width="58" height="58" /></a></div>
                    <div class="name"><a href="#">法颂浪漫梦境50ML 香水女士持久清新淡香 送2ML小样3只</a></div>
                    <div class="price"><font color="#ff4e00">￥399</font> X1</div>
                </li>
                <li>
                	<div class="img"><a href="#"><img src="/Home_/images/car2.jpg" width="58" height="58" /></a></div>
...
<div class="i_bg bg_color">
    ...
    <div class="b_btm_bg b_btm_c">
        <div class="b_btm">
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="72"><img src="/Home_/images/b1.png" width="62" height="62" /></td>
                <td><h2>正品保障</h2>正品行货  放心购买</td>
              </tr>
            </table>
			<table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="72"><img src="/Home_/images/b2.png" width="62" height="62" /></td>
                <td><h2>满38包邮</h2>满38包邮 免运费</td>
              </tr>
            </table>
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="72"><img src="/Home_/images/b3.png" width="62" height="62" /></td>
                <td><h2>天天低价</h2>天天低价 畅选无忧</td>
              </tr>
            </table>
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="72"><img src="/Home_/images/b4.png" width="62" height="62" /></td>
    ...
    <div class="b_nav">
        ...
        <div class="b_er">
            <div class="b_er_c"><img src="/Home_/images/er.gif" width="118" height="118" /></div>
            <img src="/Home_/images/ss.png" />
        </div>
    </div>    
    <div class="btmbg">
		<div class="btm">
...
<!--[if IE 6]>
<script src="/Home_///letskillie6.googlecode.com/svn/trunk/2/zh_CN.js"></script>
<![endif]-->
</html>
